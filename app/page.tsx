      ...
      <div className="flex items-center justify-center flex-col w-120 space-y-5 bg-neutral-950/80 backdrop-blur-sm border border-neutral-800 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="text-center">
            ...
            <div className="text-gray-200 text-[11px]">Years</div>
          </div>
          <div className="text-center">
            <div className="text-white text-lg font-bold">10+</div>
            <div className="text-gray-200 text-[11px]">Projects</div>
          </div>
          <div className="text-center">
            <div className="text-white text-lg font-bold">1</div>
            <div className="text-gray-200 text-[11px]">Venture</div>
          </div>
        </div>
        <div className="flex justify-center space-x-4">
          <a
            href="mailto:bartosz.krawczyk34@gmail.com"
            className="w-10 h-10 bg-neutral-900 rounded-full flex items-center justify-center text-gray-300 hover:bg-neutral-700 hover:text-white transition-colors border border-neutral-700"
          >
          ...
          <a
            href="https://linkedin.com/in/bartosz-krawczyk07"
            className="w-10 h-10 bg-neutral-900 rounded-full flex items-center justify-center text-gray-300 hover:bg-neutral-700 hover:text-white transition-colors border border-neutral-700"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
